...
import { ChevronLeft, ChevronRight, Headphones, Globe } from 'lucide-react'
...
export function ContactSupport({ onBack, onChannelClick }: ContactSupportProps) {
  const channels = [
    {
      id: 'support',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="flex items-center p-4 bg-white">
        ...
        <h1 className="text-lg font-medium ml-3">Contact Support</h1>
      </header>
        ...
        {channels.map((channel) => (
          ...
          >
            <div className="flex items-center gap-3">
              {channel.icon}
              <span className="text-[15px] text-gray-900">{channel.label}</span>
            </div>
